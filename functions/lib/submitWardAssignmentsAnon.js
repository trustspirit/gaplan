...
exports.submitWardAssignmentsAnon = void 0;
const functions = __importStar(require("firebase-functions/v1"));
const admin = __importStar(require("firebase-admin"));
const TASK_ID_RE = /^[\w-]+$/;
const DATE_RE = /^\d{4}-\d{2}-\d{2}$/;
exports.submitWardAssignmentsAnon = functions
    ...
    await db.runTransaction(async (tx) => {
        ...
        if (Array.isArray(task.availableDates) && task.availableDates.length > 0) {
            const validDates = new Set(task.availableDates);
            for (const wa of wardAssignments) {
...
//# sourceMappingURL=submitWardAssignmentsAnon.js.map