...
exports.taskCreatedNotification = void 0;
/**
...
exports.taskCreatedNotification = functions
    ...
    const respondUrl = task.respondToken
        ? `${emailHelpers_1.APP_URL}/respond/${taskId}?t=${task.respondToken}`
        : null;
...
function buildHtmlEmail(name, typeLabel, dueDate, note, tasksUrl, respondUrl = null) {
...
//# sourceMappingURL=taskCreatedNotification.js.map