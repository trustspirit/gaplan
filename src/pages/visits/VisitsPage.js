...
export function VisitsPage() {
    ...
    return (_jsx(AppShell, { role: user.role, name: user.name, topBar: _jsx(TopBar, { name: user.name, subtext: "\uC640\uB4DC \uBC29\uBB38 \uC77C\uC815" }), children: _jsx("div", { className: styles.page, children: _jsxs(Card, { children: [_jsx(CardHeader, { title: "\uC640\uB4DC \uBC29\uBB38 \uC77C\uC815" }), _jsx(CardBody, { children: visits.length === 0
