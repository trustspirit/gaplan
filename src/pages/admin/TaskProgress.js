...
function EditTaskModal({ task, onClose }) {
    ...
    return (_jsx(Modal, { open: true, onClose: onClose, title: "Task \uC218\uC815", children: _jsxs("form", { className: styles.editForm, onSubmit: handleSave, children: [isTimeBased && (_jsxs(_Fragment, { children: [_jsxs("div", { className: styles.editSection, children: [_jsx("p", { className: styles.editLabel, children: "\uAC00\uB2A5 \uB0A0\uC9DC (\uCE98\uB9B0\uB354\uC5D0\uC11C \uC120\uD0DD)" }), _jsx(MultiDatePicker, { selected: availableDates, onChange: setAvailableDates })] }), _jsxs("div", { className: styles.timeRow, children: [_jsx(Input, { label: "\uC2DC\uC791 \uC2DC\uAC04", type: "time", value: startTime, onChange: e => setStartTime(e.target.value) }), _jsx(Input, { label: "\uC885\uB8CC \uC2DC\uAC04", type: "time", value: endTime, onChange: e => setEndTime(e.target.value) })] }), _jsx(Select, { label: "\uC2DC\uAC04 \uB2E8\uC704", value: slotDuration, onChange: e => setSlotDuration(e.target.value), options: SLOT_DURATION_OPTIONS })] })), _jsx(Input, { label: "\uB9C8\uAC10\uC77C", type: "date", value: dueDate, onChange: e => setDueDate(e.target.value) }), task.status === 'responded' && (_jsx("p", { className: styles.resetNote, children: "\u26A0 \uC774\uBBF8 \uC751\uB2F5\uD55C \uB0B4\uC6A9\uC774 \uCD08\uAE30\uD654\uB418\uACE0 \uD68C\uC7A5\uC774 \uB2E4\uC2DC \uC751\uB2F5\uD574\uC57C \uD569\uB2C8\uB2E4." })), _jsxs("div", { className: styles.modalActions, children: [_jsx(Button, { variant: "ghost", type: "button", onClick: onClose, children: "\uCDE8\uC18C" }), _jsx(Button, { type: "submit", loading: saving, children: "\uC800\uC7A5 \uBC0F \uC7AC\uC804\uB2EC" })] })] }) }));
}
// ── Responded slot row ───────────────────────────────────────────────────────
