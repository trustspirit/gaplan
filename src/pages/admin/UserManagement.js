...
export function UserManagement() {
    ...
    return (_jsx(AppShell, { role: user.role, name: user.name, topBar: _jsx(TopBar, { name: user.name, subtext: "\uC0AC\uC6A9\uC790 \uAD00\uB9AC" }), children: _jsxs("div", { className: styles.page, children: [_jsxs(Card, { children: [_jsx(CardHeader, { title: "\uC0AC\uC6A9\uC790 \uCD08\uB300" }), _jsx(CardBody, { children: _jsxs("form", { className: styles.form, onSubmit: handleInvite, children: [_jsx(Input, { label: "\uC774\uBA54\uC77C", type: "email", value: email, onChange: e => setEmail(e.target.value), placeholder: "example@gmail.com", required: true }), _jsx(Select, { label: "\uC5ED\uD560", value: role, onChange: e => setRole(e.target.value), options: ROLE_OPTIONS }), role === 'seventy' && (_jsx(Select, { label: "\uB2F4\uB2F9 \uC9C0\uC5ED", value: regionId, onChange: e => setRegionId(e.target.value), options: REGION_OPTIONS })), _jsx(Button, { type: "submit", loading: loading, children: "\uCD08\uB300 \uBC1C\uC1A1" })] }) })] }), _jsxs(Card, { children: [_jsx(CardHeader, { title: "\uC804\uCCB4 \uC0AC\uC6A9\uC790" }), _jsx(CardBody, { children: users.map(u => (_jsxs("div", { className: styles.userRow, children: [_jsx(Avatar, { name: u.name, size: "sm" }), _jsxs("div", { className: styles.userInfo, children: [_jsx("p", { className: styles.userName, children: u.name }), _jsx("p", { className: styles.userEmail, children: u.email })] }), _jsx(Badge, { variant: u.role === 'admin' ? 'danger' : u.role === 'seventy' ? 'warning' : 'default', children: ROLE_LABELS[u.role] })] }, u.uid))) })] })] }) }));
}
