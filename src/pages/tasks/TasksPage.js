...
export function TasksPage() {
    ...
    return (_jsxs(AppShell, { role: user.role, name: user.name, topBar: _jsx(TopBar, { name: user.name, pendingCount: tasks.length }), children: [_jsx("div", { className: styles.page, children: _jsxs(Card, { children: [_jsx(CardHeader, { title: "\uCC98\uB9AC \uD544\uC694 Task" }), _jsx(CardBody, { children: tasksLoading
                                ...
                                : tasks.length === 0
                                    ...
                                    : tasks.map(t => _jsx(TaskCard, { task: t, onAction: openTask }, t.id)) })] }) }), isMobile ? (_jsx(BottomSheet, { open: !!activeTask, onClose: closeTask, title: "\uB0A0\uC9DC/\uC2DC\uAC04 \uC120\uD0DD", children: slotPickerContent })) : (_jsx(Modal, { open: !!activeTask, onClose: closeTask, title: "\uB0A0\uC9DC/\uC2DC\uAC04 \uC120\uD0DD", children: slotPickerContent }))] }));
}
