...
export function InterviewsPage() {
    ...
    const upcomingInterviews = allInterviews
        ...
        .slice(0, 5);
    const TABS = ['전체', '예정', '완료'];
    return (_jsx(AppShell, { role: user.role, name: user.name, topBar: _jsx(TopBar, { name: user.name, subtext: "\uC811\uACAC \uC77C\uC815" }), children: _jsxs("div", { className: styles.layout, children: [_jsxs("div", { className: styles.mainCol, children: [_jsxs("div", { className: styles.stats, children: [_jsxs("div", { className: styles.statCard, children: [_jsx("span", { className: styles.statValue, children: thisMonthCount }), _jsx("span", { className: styles.statLabel, children: "\uC774\uBC88 \uB2EC \uC811\uACAC" })] }), _jsx("div", { className: styles.statDivider }), _jsxs("div", { className: styles.statCard, children: [_jsx("span", { className: styles.statValue, children: upcomingCount }), _jsx("span", { className: styles.statLabel, children: "\uC608\uC815 \uC811\uACAC" })] }), _jsx("div", { className: styles.statDivider }), _jsxs("div", { className: styles.statCard, children: [_jsx("span", { className: styles.statValue, children: completedCount }), _jsx("span", { className: styles.statLabel, children: "\uC644\uB8CC \uC811\uACAC" })] })] }), _jsx("div", { className: styles.tabBar, children: TABS.map(tab => (_jsx("button", { type: "button", className: styles.tabBtn, "data-active": activeTab === tab, onClick: () => setActiveTab(tab), children: tab }, tab))) }), _jsx("div", { className: styles.content, children: orderedKeys.length === 0 ? (_jsxs("div", { className: styles.empty, children: [_jsx(Users, { size: 32, className: styles.emptyIcon }), _jsx("p", { className: styles.emptyTitle, children: "\uC811\uACAC \uC77C\uC815\uC774 \uC5C6\uC2B5\uB2C8\uB2E4" }), _jsx("p", { className: styles.emptyDesc, children: activeTab === '예정' ? '아직 예정된 접견이 없습니다.' : activeTab === '완료' ? '완료된 접견이 없습니다.' : '확정된 접견 일정이 없습니다.' })] })) : (orderedKeys.map(monthKey => {
                                const items = grouped.get(monthKey);
                                return (_jsxs("div", { className: styles.monthGroup, children: [_jsx("h3", { className: styles.monthLabel, children: monthKey }), _jsx("div", { className: styles.itemList, children: items.map(s => (_jsx(ScheduleItem, { schedule: s, unitName: getUnitName(s.unitId) }, s.id))) })] }, monthKey));
                            })) })] }), _jsx("div", { className: styles.sideCol, children: _jsxs("div", { className: styles.sideCard, children: [_jsx("div", { className: styles.sideCardHeader, children: "\uB2E4\uC74C \uC811\uACAC \uC608\uC815" }), _jsx("div", { className: styles.sideCardBody, children: upcomingInterviews.length === 0 ? (_jsx("p", { className: styles.sideEmpty, children: "\uC608\uC815\uB41C \uC811\uACAC\uC774 \uC5C6\uC2B5\uB2C8\uB2E4." })) : (upcomingInterviews.map(s => (_jsxs("div", { className: styles.upcomingItem, children: [_jsx("span", { className: styles.upcomingDate, children: dayjs(s.date).format('M/D (ddd)') }), _jsx("span", { className: styles.upcomingUnit, children: getUnitName(s.unitId) })] }, s.id)))) })] }) })] }) }));
}
