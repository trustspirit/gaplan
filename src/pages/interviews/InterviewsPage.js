...
export function InterviewsPage() {
    ...
    return (_jsx(AppShell, { role: user.role, name: user.name, topBar: _jsx(TopBar, { name: user.name, subtext: "\uC811\uACAC \uC77C\uC815" }), children: _jsx("div", { className: styles.page, children: _jsxs(Card, { children: [_jsx(CardHeader, { title: "\uC811\uACAC \uC77C\uC815" }), _jsx(CardBody, { children: interviews.length === 0
