...
export function InterviewsPage() {
    ...
    return (_jsx(AppShell, { role: user.role, name: user.name, topBar: _jsx(TopBar, { name: user.name, subtext: t('interviews.title') }), children: _jsxs("div", { className: styles.layout, children: [_jsxs("div", { className: styles.mainCol, children: [_jsxs("div", { className: styles.stats, children: [_jsxs("div", { className: styles.statCard, children: [_jsx("span", { className: styles.statValue, children: thisMonthCount }), _jsx("span", { className: styles.statLabel, children: t('interviews.thisMonth') })] }), _jsx("div", { className: styles.statDivider }), _jsxs("div", { className: styles.statCard, children: [_jsx("span", { className: styles.statValue, children: upcomingCount }), _jsx("span", { className: styles.statLabel, children: t('interviews.upcoming') })] }), _jsx("div", { className: styles.statDivider }), _jsxs("div", { className: styles.statCard, children: [_jsx("span", { className: styles.statValue, children: completedCount }), _jsx("span", { className: styles.statLabel, children: t('interviews.completed') })] })] }), _jsx("div", { className: styles.tabBar, children: TABS.map(tab => (_jsx("button", { type: "button", className: styles.tabBtn, "data-active": activeTab === tab, onClick: () => setActiveTab(tab), children: t(`visits.tabs.${tab}`) }, tab))) }), _jsx("div", { className: styles.content, children: orderedKeys.length === 0 ? (_jsxs("div", { className: styles.empty, children: [_jsx(Users, { size: 32, className: styles.emptyIcon }), _jsx("p", { className: styles.emptyTitle, children: t('interviews.empty') }), _jsx("p", { className: styles.emptyDesc, children: activeTab === 'upcoming' ? t('interviews.noUpcoming') : activeTab === 'completed' ? t('interviews.noCompleted') : t('interviews.noAll') })] })) : (orderedKeys.map(monthKey => {
                            ...
                            })) })] }), _jsx("div", { className: styles.sideCol, children: _jsxs("div", { className: styles.sideCard, children: [_jsx("div", { className: styles.sideCardHeader, children: t('interviews.nextInterviews') }), _jsx("div", { className: styles.sideCardBody, children: upcomingInterviews.length === 0 ? (_jsx("p", { className: styles.sideEmpty, children: t('interviews.noUpcoming') })) : (upcomingInterviews.map(s => (_jsxs("div", { className: styles.upcomingItem, children: [_jsx("span", { className: styles.upcomingDate, children: dayjs(s.date).format('M/D (ddd)') }), _jsx("span", { className: styles.upcomingUnit, children: getUnitName(s.unitId) })] }, s.id)))) })] }) })] }) }));
}
