...
function PresidentDashboard() {
    ...
    return (_jsxs(AppShell, { role: user.role, name: user.name, topBar: _jsx(TopBar, { name: user.name, subtext: dayjs().format('YYYY년 M월'), pendingCount: tasks.length }), children: [_jsxs("div", { className: styles.grid, children: [_jsxs(Card, { className: styles.calendarConnectCard, children: [_jsx(CardHeader, { title: "\uAD6C\uAE00 \uCE98\uB9B0\uB354", action: _jsx(CalendarConnectCard, { connected: user.calendarConnected }) }), _jsx(CardBody, { children: _jsx("p", { className: styles.calendarDesc, children: "\uAD6C\uB3C5\uD558\uBA74 \uBAA8\uB4E0 \uD655\uC815 \uC77C\uC815\uC774 \uD578\uB4DC\uD3F0 \uBC0F Google \uCE98\uB9B0\uB354\uC5D0 \uC790\uB3D9\uC73C\uB85C \uB098\uD0C0\uB0A9\uB2C8\uB2E4." }) })] }), _jsxs(Card, { children: [_jsx(CardHeader, { title: "\uCC98\uB9AC \uD544\uC694" }), _jsx(CardBody, { children: tasksLoading
                                    ...
                                    : tasks.length === 0
                                        ...
                                        : tasks.map(t => _jsx(TaskCard, { task: t, onAction: openTask }, t.id)) })] }), _jsxs(Card, { children: [_jsx(CardHeader, { title: "\uD655\uC815 \uC77C\uC815" }), _jsx(CardBody, { children: schedulesLoading
                                    ? [1, 2].map(i => _jsx(Skeleton, { height: "44px", className: styles.skeletonItem }, i))
                                    : upcoming.length === 0
                                        ? _jsx("p", { className: styles.empty, children: "\uC608\uC815\uB41C \uC77C\uC815\uC774 \uC5C6\uC2B5\uB2C8\uB2E4." })
                                        : upcoming.map(s => _jsx(ScheduleItem, { schedule: s, unitName: getUnitName(s.unitId) }, s.id)) })] }), _jsxs(Card, { className: styles.calendarCard, children: [_jsx(CardHeader, { title: "\uCE98\uB9B0\uB354" }), _jsx(CardBody, { children: _jsx(CalendarView, { schedules: schedules }) })] })] }), isMobile ? (_jsx(BottomSheet, { open: !!activeTask, onClose: closeTask, title: "\uB0A0\uC9DC/\uC2DC\uAC04 \uC120\uD0DD", children: slotPickerContent })) : (_jsx(Modal, { open: !!activeTask, onClose: closeTask, title: "\uB0A0\uC9DC/\uC2DC\uAC04 \uC120\uD0DD", children: slotPickerContent }))] }));
}
function SeventyDashboard() {
    ...
    return (_jsx(AppShell, { role: user.role, name: user.name, topBar: _jsx(TopBar, { name: user.name, subtext: regionName }), children: _jsxs("div", { className: styles.grid, children: [_jsxs(Card, { className: styles.calendarConnectCard, children: [_jsx(CardHeader, { title: "\uAD6C\uAE00 \uCE98\uB9B0\uB354", action: _jsx(CalendarConnectCard, { connected: user.calendarConnected }) }), _jsx(CardBody, { children: _jsx("p", { className: styles.calendarDesc, children: "\uAD6C\uB3C5\uD558\uBA74 \uBAA8\uB4E0 \uD655\uC815 \uC77C\uC815\uC774 \uD578\uB4DC\uD3F0 \uBC0F Google \uCE98\uB9B0\uB354\uC5D0 \uC790\uB3D9\uC73C\uB85C \uB098\uD0C0\uB0A9\uB2C8\uB2E4." }) })] }), _jsxs(Card, { children: [_jsx(CardHeader, { title: "\uC774\uBC88 \uB2EC \uC77C\uC815" }), _jsx(CardBody, { children: thisMonth.length === 0
