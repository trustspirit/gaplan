...
function AdminDashboardContent() {
    ...
    return (_jsx(AppShell, { sidebar: _jsx(Sidebar, { role: user.role, name: user.name }), topBar: _jsx(TopBar, { name: user.name }), children: _jsx("div", { className: styles.grid, children: _jsxs(Card, { className: styles.calendarCard, children: [_jsx(CardHeader, { title: "\uC804\uCCB4 \uC77C\uC815" }), _jsx(CardBody, { children: _jsx(CalendarView, { schedules: schedules }) })] }) }) }));
}
