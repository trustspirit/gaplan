...
// UserManagement.tsx 48-50에서 옮겨왔다. 라벨(ROLE_LABELS)은 아직 i18n으로 옮겨지지
// 않은 기존 상수라 이 분리 작업 범위 밖이다 — 그대로 옮긴다.
...
/**
 * UserManagement.tsx 42-45에서 옮겨왔다. 하드코딩된 '없음'(43)을 `common.none`
 * 키로 바꿨다 — 그 키는 이미 ko/en 양쪽에 있다. 번역이 필요해 top-level 상수가
 * 아니라 t를 받는 함수가 됐다.
 */
