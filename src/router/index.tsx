...
const OnboardingPage = lazyRetry(() => import('@/pages/auth/OnboardingPage').then(m => ({ default: m.OnboardingPage })))
const PendingPage = lazyRetry(() => import('@/pages/auth/PendingPage').then(m => ({ default: m.PendingPage })))
...
const SchedulesPage = lazyRetry(() => import('@/pages/schedules/SchedulesPage').then(m => ({ default: m.SchedulesPage })))
const TasksPage = lazyRetry(() => import('@/pages/tasks/TasksPage').then(m => ({ default: m.TasksPage })))
const AdminDashboard = lazyRetry(() => import('@/pages/admin/AdminDashboard').then(m => ({ default: m.AdminDashboard })))
const UserManagement = lazyRetry(() => import('@/pages/admin/UserManagement').then(m => ({ default: m.UserManagement })))
const TaskCreation = lazyRetry(() => import('@/pages/admin/RegionSettings').then(m => ({ default: m.TaskCreation })))
const TaskProgress = lazyRetry(() => import('@/pages/admin/TaskProgress').then(m => ({ default: m.TaskProgress })))
const StatsPage = lazyRetry(() => import('@/pages/admin/StatsPage').then(m => ({ default: m.StatsPage })))
const AvailabilitySettings = lazyRetry(() => import('@/pages/admin/AvailabilitySettings').then(m => ({ default: m.AvailabilitySettings })))
const CalendarSettings = lazyRetry(() => import('@/pages/admin/CalendarSettings').then(m => ({ default: m.CalendarSettings })))
const VisitPlanner = lazyRetry(() => import('@/pages/admin/VisitPlanner').then(m => ({ default: m.VisitPlanner })))
const VisitPlanListPage = lazyRetry(() => import('@/pages/admin/VisitPlanListPage').then(m => ({ default: m.VisitPlanListPage })))
