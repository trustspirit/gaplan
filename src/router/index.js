...
export function AppRouter() {
    return (_jsx(BrowserRouter, { children: _jsxs(Routes, { children: [_jsx(Route, { path: "/login", element: _jsx(LoginPage, {}) }), _jsx(Route, { path: "/onboarding", element: _jsx(OnboardingPage, {}) }), _jsx(Route, { path: "/pending", element: _jsx(PendingPage, {}) }), _jsxs(Route, { element: _jsx(ProtectedRoute, {}), children: [_jsx(Route, { path: "/dashboard", element: _jsx(DashboardPage, {}) }), _jsx(Route, { path: "/calendar", element: _jsx(CalendarPage, {}) }), _jsx(Route, { path: "/visits", element: _jsx(VisitsPage, {}) }), _jsx(Route, { path: "/interviews", element: _jsx(InterviewsPage, {}) }), _jsx(Route, { element: _jsx(RoleRoute, { allow: ['president'] }), children: _jsx(Route, { path: "/tasks", element: _jsx(TasksPage, {}) }) }), _jsxs(Route, { element: _jsx(RoleRoute, { allow: ['admin'] }), children: [_jsx(Route, { path: "/admin", element: _jsx(AdminDashboard, {}) }), _jsx(Route, { path: "/admin/users", element: _jsx(UserManagement, {}) }), _jsx(Route, { path: "/admin/tasks", element: _jsx(TaskCreation, {}) }), _jsx(Route, { path: "/admin/availability", element: _jsx(AvailabilitySettings, {}) }), _jsx(Route, { path: "/admin/calendar", element: _jsx(CalendarSettings, {}) }), _jsx(Route, { path: "/admin/visit-planner", element: _jsx(VisitPlanner, {}) })] }), _jsx(Route, { element: _jsx(RoleRoute, { allow: ['admin', 'seventy'] }), children: _jsx(Route, { path: "/admin/task-progress", element: _jsx(TaskProgress, {}) }) })] }), _jsx(Route, { path: "/respond/:taskId", element: _jsx(RespondPage, {}) }), _jsx(Route, { path: "*", element: _jsx(Navigate, { to: "/dashboard", replace: true }) })] }) }));
}
