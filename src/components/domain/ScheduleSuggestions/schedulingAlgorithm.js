...
function sortSlots(slots, strategy, usedDates) {
    return [...slots].sort((a, b) => {
        ...
        if (strategy === 'afternoon') {
            ...
            if (aAfternoon !== bAfternoon)
                return aAfternoon - bAfternoon;
...
function greedyAssign(respondents, strategy) {
...
export function generateSuggestions(respondents) {
