...
export function CalendarView({ schedules, onDateClick, selectedDate, getUnitName, defaultView = 'month', }) {
    ...
    const renderWeekView = () => {
        ...
        return (_jsxs("div", { className: styles.timeAxisWrap, children: [_jsxs("div", { className: styles.mobileDayNav, children: [_jsx("button", { type: "button", className: styles.mobileDayNavBtn, onClick: () => setWeekOffset(o => Math.max(0, o - 3)), disabled: weekOffset === 0, children: "\u2039" }), _jsxs("span", { className: styles.mobileDayNavLabel, children: [allDays[weekOffset]?.format('M/D'), " \u2013 ", allDays[Math.min(weekOffset + 2, 6)]?.format('M/D')] }), _jsx("button", { type: "button", className: styles.mobileDayNavBtn, onClick: () => setWeekOffset(o => Math.min(4, o + 3)), disabled: weekOffset >= 4, children: "\u203A" })] }), _jsxs("div", { className: styles.timeAxis, children: [_jsxs("div", { className: styles.timeGutter, children: [_jsx("div", { className: styles.timeGutterHeader }), HOURS.map(h => (_jsxs("div", { className: styles.timeLabel, style: { height: HOUR_HEIGHT }, children: [String(h).padStart(2, '0'), ":00"] }, h)))] }), _jsx("div", { className: styles.dayColumns, children: allDays.map((d, idx) => {
                                const dateStr = d.format('YYYY-MM-DD');
                                const daySchedules = getSchedulesForDate(dateStr);
                                const isToday = d.isSame(dayjs(), 'day');
                                const isBlocked = isFastSunday(d);
